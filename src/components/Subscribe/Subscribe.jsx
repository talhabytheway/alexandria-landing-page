    ...
    <div className="py-24 xl:mx-auto px-[1.5rem] md:px-[3rem] lg:px-[6rem] lg:max-w-[1500px]">
      <div className="items-center flex gap-8 flex-col">
        ...
        <div className="w-full max-w-[600px] flex h-[50px] items-center">
          <input type="text" name="" id="" placeholder="Enter your email address" className="w-[70%] sm:w-[80%] pl-2 inline-block h-full rounded-lg focus-visible:outline-[#DEDFE2] border-2 border-r-0 rounded-r-none border-[#DEDFE2]"/>
          <div className="text-[14px] lg:text-[16px] font-open w-[30%] sm:w-[20%] bg-blue cursor-pointer text-center  text-white font-medium rounded-lg rounded-l-none py-[15px] lg:py-[14px]">SEND</div>
        </div>
      </div>
    </div>
  );
